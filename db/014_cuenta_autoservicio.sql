-- =============================================================================
-- 014_cuenta_autoservicio.sql
-- Desarrollado por Marco Antonio Posligua San Martín
--
-- Módulo de administración de la propia cuenta:
--   * El usuario (admin, trabajador, usuario) mantiene sus datos.
--   * Cambia su clave verificando la anterior.
--   * Si la olvidó, el administrador la restablece con una clave temporal de un
--     solo uso; la API obliga a cambiarla antes de dejar operar.
--
-- Idempotente. Aplicar en el editor SQL de Supabase (o vía POST /admin/migrate).
-- =============================================================================
...
-- La API entra con service_role; RLS cerrada como el resto del esquema.
