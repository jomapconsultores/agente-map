...
// Empaquetado móvil de Proyectos MAP.
//
...
//
// El destino es el despliegue en Coolify: https://proyectos.pensamiento-libre.org
...
const APP_URL = process.env.APP_URL || 'https://proyectos.pensamiento-libre.org';

const config: CapacitorConfig = {
  appId: 'ec.map.proyectos',
  appName: 'Proyectos MAP',
  webDir: 'www',
  ...
  plugins: {
    StatusBar: { style: 'DARK', backgroundColor: '#0b1f33' },
  },
};
